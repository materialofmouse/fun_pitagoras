...
void setup(){
  ...
  seq.add(Ani.to(this, 1, "eff5_1",600,Ani.SINE_IN, "onStart:servo2"));
  seq.add(Ani.to(this, 1, "eff5_2", -1500 * 1.41, Ani.SINE_IN));
	seq.beginStep();
	seq.add(Ani.to(this, 3, "ballX2", 0, Ani.LINEAR));
